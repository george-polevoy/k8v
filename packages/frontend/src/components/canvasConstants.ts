...
export const TEXT_OUTPUT_OVERLAY_PADDING_X = 10;
export const TEXT_OUTPUT_OVERLAY_PADDING_Y = 8;
export const TEXT_OUTPUT_OVERLAY_FONT_SIZE = 12;
export const TEXT_OUTPUT_OVERLAY_LINE_HEIGHT_PX = 16;
